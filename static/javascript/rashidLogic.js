...
function getFirstResponse() {
    addBotMessage(getResponse("Introduction Rashid"));
}
...
function addBotMessage(text) {
    let botHtml = '<div class="message"><div class="message-botname">Rashid</div><div class="botText"><div class="avatar-wrapper"><img class="avatar" src="/static/img/Rashid.svg"></div><div class="data-wrapper">' + text + '</div></div><div class="message-time">' + getTime() + '</div></div>';
...
function addTypingMessage() {
    let botHtml = '<div class="message typing"><div class="message-botname">Rashid</div><div class="botText"><div class="avatar-wrapper"><img class="avatar" src="/static/img/Rashid.svg"></div><div class="data-wrapper"><img src="/static/img/typing3.gif"></div></div></div>';
    $("#chatbox").append(botHtml);
    scrollDown();
}
