...
botAvatar = "/static/Logo_HSG.png" ##Ändern des Avatars des Chatbots. Hier kann sowohl ein Bild im /static Ordner genannt werden, als auch eine URL
chatBackground = "/static/HSG.png"  ##Ändern des Hintergrundes hinter der Messaging Box .Hier kann sowohl ein Bild im /static Ordner genannt werden, als auch eine URL
