...
bot_model_db = os.path.join(file_directory, "bots/botData.sqlite3")
...
def tryGoogle(myQuery):
	...
	return "<br><br>Hier kannst du gerne meinen Freund Google fragen: <a target='_blank' href='https://www.google.com/search?q=" + myQuery + "'>" + myQuery + "</a>"
