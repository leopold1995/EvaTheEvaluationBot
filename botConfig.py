...
##Ändere die folgenden Werte, um deinen Chatbot zu Individualisieren:
myBotName = "Riddler"
...
useGoogle = "yes" ## Yes - Bei nicht wissen durchsucht der Bot google nach dem unbekannten Begriff und gibt einen Link. No - Google wird nicht zur Hilfe gezogen
confidenceLevel = 0.65 ##Bot confidence level - Muss zwischen 0 und 1 liegen. Je höher der Wert, desto sicherer muss sich der Bot seiner Antwort sein
